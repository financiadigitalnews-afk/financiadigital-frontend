...
const totalCount = savedGallery.length + newGalleryFiles.length;
...
<div className="rounded-lg border border-dashed border-blue-200 bg-blue-50/40 p-4 space-y-3">
  ...
  {savedGallery.length > 0 && (
    <div>
      ...
      <div className="flex flex-wrap gap-1">
        {savedGallery.map((img, i) => (
          <div key={i} className="relative overflow-hidden rounded-lg border border-blue-100">
  ...
  <p className="text-[10px] text-blue-400">Saved images are kept. New images are added alongside them.</p>
        ...
        <div className="flex items-center justify-between gap-3 border-t border-gray-100 pt-4">
          ...
          <button
            onClick={() => onSave({ ...f, hashtags: normalizeHashtags(hashTxt) }, file, newGalleryFiles)}
            disabled={saving || !f.title || (isVideo && !f.videoId)}
